    ...
    <footer className="w-full bg-[#111111] text-white border-t border-neutral-800/60 select-none">
      <div className="site-container pt-12 sm:pt-16 pb-8">
          ...
          <div className="group">
            ...
            {/* Customizable Animated Gradient Line (Aap colors array me koi bhi colors pass kar sakte ho) */}
            <GradientDivider
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 py-12 sm:py-16">
            ...
            <div className="md:col-span-6 lg:col-span-5 flex flex-col items-start">
              ...
              <p className="text-neutral-400 text-sm sm:text-[15px] leading-relaxed max-w-md">
            ...
            {/* Columns 2 & 3: Quick Links and Contact Us (Side by side in 2 columns on mobile, individual columns on md+) */}
                ...
                <ul className="space-y-3">
                  {quickLinks.map((item) => (
                    <li key={item.label}>
                      <Link
                        href={item.href}
                        className="text-neutral-400 hover:text-white transition-colors duration-200 text-sm sm:text-[15px]"
                      >
                        {item.label}
                      </Link>
                    </li>
              ...
              <div className="md:col-span-3 lg:col-span-4">
                ...
                <div className="space-y-4 text-sm sm:text-[15px]">
                  <div>
                    ...
                    <p className="text-neutral-400 mt-0.5">Abbotsford B.C, Canada</p>
                  </div>
          ...
          <div className="border-t border-neutral-800/80 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-neutral-400">
            <p>
              Wolverines © 2026 | Designed by{" "}
              <span className="text-neutral-300 font-medium">XYZ Studio</span>
            </p>
